...
- [The week in .NET – Command Line Parser Library, .NET South East](https://blogs.msdn.microsoft.com/dotnet/2017/07/18/the-week-in-net-command-line-parser-library-net-south-east/)
- [5 Ways to Export from ASP.NET to Word and PDF Files](http://developer.telerik.com/topics/net/5-ways-export-asp-net-word-pdf-file/)
